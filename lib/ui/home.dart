...
import 'package:chopperflutter/network/model/network_movie.dart';
import 'package:chopperflutter/network/network_services/api_service.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          _movie != null
              ? _movie.title != null ? _movieDetails() : Container()
              : Container(),
        ],
      ),
    );
